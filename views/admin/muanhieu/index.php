...
<head>
    ...
    <title>Thống kê điện thoại mua nhiều</title>
</head>
<body name="muanhieu">
<div class="wrapper">
    ...
    <div class="content">
        ...
        <div class="content-page">
            <div class="title">
                <h4>Thống kê điện thoại mua nhiều</h4>
            </div>
            <div class="quanly">
                <table class="table-list">
                    ...
                    <tr>
                        ...
                        <th class="txt-center">Số lượng đã bán</th>
                    </tr>
                    </thead>
                    <tbody>
                    <?php
                    foreach ($data as $row) {
                        ...
                        <tr>
                            ...
                            <td><?php
                                ...
                                ?></td>
                            <td class="txt-center"><?php echo $row["sp_count"] ?></td> <!-- Hiển thị số lượng đã bán -->
                        </tr>
                        <?php
                    }
                    ?>
